...
|<h5>Strawberry latte</h5> &nbsp; 딸기 라떼 <br/>✓ Only ice|6.0  |
|:---------------------------------------------------------------|----:|
|생딸기로 만든 청에 우유를 섞은 음료                                |     |
<br/>
...
|<h5>Strawberry tea</h5> &nbsp; 딸기티 <br/>✓ Only hot            |5.0  |
|:---------------------------------------------------------------|----:|
|따뜻한 물에 생딸기로 만든 청을 섞어 만든 달콤한 차                  |     |
<br/>
...
|<h5>Strawberry pistachio tart</h5> &nbsp; 딸기 피스타치오 타르트  |8.6  |
|:---------------------------------------------------------------|----:|
|피스타치오의 진한 맛과 딸기의 상큼한 맛이 조화로운 타르트            |     |
<br/>

|<h5>Strawberry chocolate cupcake</h5> &nbsp; 딸기 초콜릿 컵케이크 |6.5  |
|:---------------------------------------------------------------|----:|
|진한 초콜릿 시트 위에 생딸기와 달콤한 딸기 크림을 올린 컵케이크      |     |
<br/>
